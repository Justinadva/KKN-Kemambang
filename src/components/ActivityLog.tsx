              ...
              <div className="divide-y divide-black/4">
                {filtered.map((entry, i) => (
                  <motion.div
                    ...
                    className="flex flex-col sm:grid sm:grid-cols-[auto,1fr,auto,auto] gap-2 sm:gap-4 px-4 sm:px-6 py-3.5 hover:bg-black/2 transition-colors"
                  >
                    {/* Row 1 (mobile): Badge + Description */}
                    ...
                    {/* Row 2 (mobile): Value + Time side by side */}
